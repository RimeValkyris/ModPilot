    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          // `min-width: auto`, so one long unbreakable line (an installer's
          // download URL, a file path) sizes the track to its min-content
          // and the dialog's own max-width can't hold it - the content
          // then renders outside the painted panel.
